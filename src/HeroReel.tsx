...
const reelSegments = [
  ...
  { end: 39.4333, mode: 'Autonomous outer policy', task: 'Dual-object transfer', detail: 'Rollout 01 · collect both objects → dispose', speed: '3×' },
    ...
    <figure className="hero-media hero-video-shell">
      <div className="hero-reel">
        <video
          ...
          loop
          playsInline
          poster={asset('media/hero-action-cut-poster.jpg?v=6')}
          onTimeUpdate={(event) => {
        ...
        >
          <source src={asset('media/hero-action-cut.mp4?v=6')} type="video/mp4" />
        </video>
